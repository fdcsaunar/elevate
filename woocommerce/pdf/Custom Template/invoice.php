...
<h1 class="document-type-label">Orders</h1>
		...
		<td class="order-data">
			<table>
				...
				<tr class="order-number">
					...
					<td><?php echo $pickup_date = get_post_meta( $this->order->get_id(), '_billing_cstm_wp_order_number', true ); ?></td>
				</tr>
...
<table class="order-details">
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
			...
			<td class="category"><?php echo $terms[0]->name; ?></td>
			<td class="order-number"><?php echo $item['sku']; ?></td>
	...
	<tfoot>
		<tr class="no-borders">
			...
			<td class="no-borders" colspan="2">
				<table class="totals">
					<tfoot>
						<?php $i=0; foreach( $this->get_woocommerce_totals() as $key => $total ) : if( $i != 0 ): ?>
						<tr class="<?php echo $key; ?>">
							<td class="no-borders"></td>
							<th class="description">Total: Ex GST</th>
